...
OUTPUT_README = "../src/images/ubuntu-base/readme.md"
IMAGE_URI = "public.ecr.aws/dev1-sg/devcontainer/ubuntu-base:latest"
...
def main():
    ...
    pkg_output_str = run_container_command(client, image_name, "sh -c 'apt list | tail -n +2'", arch)
