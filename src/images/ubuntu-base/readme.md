...
**Image**: public.ecr.aws/dev1-sg/devcontainer/ubuntu-base:latest
...
curl/now 8.5.0-2ubuntu10.6 amd64 [installed,local]
...
git-man/now 1:2.43.0-1ubuntu7.2 all [installed,local]
git/now 1:2.43.0-1ubuntu7.2 amd64 [installed,local]
...
jq/now 1.7.1-3build1 amd64 [installed,local]
libacl1/now 2.3.2-1build1.1 amd64 [installed,local]
libapparmor1/now 4.0.1really4.0.1-0ubuntu0.24.04.4 amd64 [installed,local]
...
libcurl3t64-gnutls/now 8.5.0-2ubuntu10.6 amd64 [installed,local]
...
libjq1/now 1.7.1-3build1 amd64 [installed,local]
...
libonig5/now 6.9.9-1build1 amd64 [installed,local]
...
locales-all/now 2.39-0ubuntu8.4 amd64 [installed,local]
...
sudo/now 1.9.15p5-3ubuntu5 amd64 [installed,local]
...
last_updated: ('Sun Jun 22 21:33:04 2025', '+08')